...
export const getContentInput = () => cy.get('textarea[data-placeholder="Content"]')
export const getAddFileButton = () => cy.get('button:contains("Add")')

export const getFileRow = (fileName: string, content: string) => cy.get(`mat-row:contains("${fileName}${content}")`)
export const getDeleteFileButton = () => cy.get('button:contains("delete")')
export const getConfirmDeletionButton = () => cy.get('button:contains("Delete file")')
